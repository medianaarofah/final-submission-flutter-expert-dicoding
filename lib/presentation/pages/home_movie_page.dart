...
class _HomeMoviePageState extends State<HomeMoviePage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<NowPlayingMovieBloc>().add(OnNowPlayingMovieAppearing());
            ...
            children: [
              ...
              BlocBuilder<NowPlayingMovieBloc, NowPlayingMovieState>(
                ...
                if (state is NowPlayingMovieLoading) {
                  ...
                  final dataMoviesResult = state.result;
                  return MovieList(dataMoviesResult);
