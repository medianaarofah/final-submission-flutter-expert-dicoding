...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<MovieDetailBloc>().add(OnDetailMovieAppearing(widget.id));
      context
          .read<MovieRecommendationsBloc>()
          .add(OnRecommendationsMovieAppearing(widget.id));
      context.read<WatchlistMovieBloc>().add(WatchlistMovie(widget.id));
    });
  }
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                String message = "";
                                String addMessage = "Added to Watchlist Movie";
                                String removeMessage =
                                    "Removed from Watchlist Movie";
